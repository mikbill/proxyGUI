...
return [
     ...
     */
    'intro_text' => <<<INTRO
Документация API для работы с ProxyGUI.

<aside>В правой части можно увидеть примеры API запросов на разных языках (переключение языка доступно в верхней части)</aside>
INTRO
    ,
